...
function checkBatsmanFile(teamName , batsmanName ){
    let batsmanFPath = `./IPL/${teamName}/${batsmanName}.json`;
    return fs.existsSync(batsmanFPath);
}

function updateBatsmanFile( teamName , batsmanName , runs, balls, fours, sixes ){
    let batsmanFPath = `./IPL/${teamName}/${batsmanName}.json`;
    let batsmanFile = fs.readFileSync(batsmanFPath);
    ...
    //first argument -> path , seconf argument -> normal object converted into JSON form
    fs.writeFileSync(batsmanFPath, JSON.stringify(batsmanFile)); 
}
